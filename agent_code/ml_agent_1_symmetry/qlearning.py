...
class QLearningModel:
    ...
    def setupTraining(self, alpha, gamma, buffer_size, n=0, initial_beta=None, feature_rotate_mirror=None):
        ...
        self.feature_rm = feature_rotate_mirror     # TODO: Add comment for this parameter
